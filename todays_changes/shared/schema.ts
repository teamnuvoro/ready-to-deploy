...
import { pgTable, text, varchar, timestamp, boolean, uuid, numeric, integer, pgEnum } from "drizzle-orm/pg-core";
...
export const users = pgTable("users", {
  ...
  personalityModel: text("personality_model").default("riya_classic"), // Selected AI girlfriend personality
...
export const avatarStyles = ["anime", "realistic", "semi_realistic", "artistic"] as const;
export type AvatarStyle = (typeof avatarStyles)[number];

export const personalityVisuals = ["girl_next_door", "elegant", "sporty", "artsy", "professional"] as const;
export type PersonalityVisual = (typeof personalityVisuals)[number];

export const avatarConfigurations = pgTable("avatar_configurations", {
  id: uuid("id").defaultRandom().primaryKey(),
  userId: uuid("user_id").notNull().references(() => users.id),
  avatarStyle: text("avatar_style").$type<AvatarStyle>().default("anime").notNull(),
  skinTone: text("skin_tone"),
  hairColor: text("hair_color"),
  hairStyle: text("hair_style"),
  eyeColor: text("eye_color"),
  outfit: text("outfit"),
  personalityVisual: text("personality_visual").$type<PersonalityVisual>().default("girl_next_door"),
...
export const memoryTypeEnum = pgEnum("memory_type", [
  ...
  "personal_goal", "hobby", "stress_point"
]);
